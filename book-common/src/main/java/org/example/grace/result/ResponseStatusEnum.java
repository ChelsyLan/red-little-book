...
public enum ResponseStatusEnum {
    ...
    // 50x
    UN_LOGIN(501,false,"please sign in first！"),

    TICKET_INVALID(502,false,"session expired, please sign in again！"),

    NO_AUTH(503,false,"sorry, you don't have that authorization"),

    MOBILE_ERROR(504,false,"fail to send the message,please retry"),
    ...
    USER_UPDATE_ERROR(508,false,"fail to update the user information,please contact the admin"),

    USER_INACTIVE_ERROR(509,false,"请前往[账号设置]修改信息激活后再进行后续操作！"),

    USER_INFO_UPDATED_ERROR(5091,false,"fail to update the user information！"),

    USER_INFO_UPDATED_NICKNAME_EXIST_ERROR(5092,false,"nickname already exsits！"),
